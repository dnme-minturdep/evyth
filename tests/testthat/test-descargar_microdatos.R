test_that("Descarga de EVyTH", {
  skip_if_offline()
  expect_error(base <- descargar_microdatos(anio = 2011, trimestre = 2, variables =  c('anio','tipo_visitante','pondera')))
  base <- descargar_microdatos(anio = 2019, trimestre = 2, variables =  c('anio', 'trimestre', 'tipo_visitante','pondera'))
